    ...
    return (
        <div className={styles.container} style={{}} >
            <div className={styles.imageBox360}>
                <iframe width="100%" height="100%" className={styles.iframe} frameBorder="0" allow="xr-spatial-tracking; gyroscope; accelerometer" allowFullScreen scrolling="no" src={active?.image360 || ''}></iframe>
            </div>
